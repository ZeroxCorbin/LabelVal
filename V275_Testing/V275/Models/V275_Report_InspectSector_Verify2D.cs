...
{
    public class V275_Report_InspectSector_Verify2D : Core.BaseViewModel
    {
        ...
        public class Data : Core.BaseViewModel
        {
            ...
            public V275_Report_InspectSector_Common.GradeValue reflectanceMargin { get; set; }
        ...
        {
            public V275_Report_InspectSector_Common.ValueResult symbolWidth { get; set; }
