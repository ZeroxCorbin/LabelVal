...
public partial class NHibernateSettingsViewModel : ObservableObject
{

    public ObservableCollection<string> SQLConfigurations { get; } = [];
    ...
    public NHibernateSettingsViewModel() => LoadSQLConfigurations();
