...
namespace LabelVal.ImageViewer3D.ViewModels
{
    ...
    public abstract partial class BaseViewModel : ObservableObject, IDisposable
    {
        ...
        [ObservableProperty] private string cameraModel = "CameraModel";
        partial void OnCameraModelChanged(string value) => OnCameraModelChanged();

        [ObservableProperty] private Camera camera;
        partial void OnCameraChanged(Camera value) => CameraModel = value is PerspectiveCamera
                                                                   ? Perspective
                                                                   : value is OrthographicCamera ? Orthographic : null;

        [ObservableProperty] private string subTitle = "SubTitle";
        ...
        [ObservableProperty] private IEffectsManager effectsManager;
